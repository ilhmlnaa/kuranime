...
export function AppHeader() {
  ...
  return (
    ...
    >
      <div className="flex h-16 items-center gap-4 border-b border-[#00a3ff]/20 bg-linear-to-r from-[#070a10] via-[#091120] to-[#070a10] px-6 backdrop-blur-md shadow-[0_4px_20px_rgba(0,163,255,0.05)]">
        {/* Search bar */}
